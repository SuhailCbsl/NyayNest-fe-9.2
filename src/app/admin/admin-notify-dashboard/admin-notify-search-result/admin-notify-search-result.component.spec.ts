...
export const mockAdminNotifyMessages = [
  {
    ...
    _links: {
      self: {
        href: 'http://localhost:8081/server/api/ldn/messages/urn:uuid:5fb3af44-d4f8-4226-9475-2d09c2d8d9e0',
      },
    },
    thumbnail: 'test',
    item: {},
  ...
  },
  {
    ...
    _links: {
      self: {
        href: 'http://localhost:8081/server/api/ldn/messages/urn:uuid:544c8777-e826-4810-a625-3e394cc3660d',
      },
    },
    thumbnail: {},
    item: {},
...
describe('AdminNotifySearchResultComponent', () => {
  ...
  beforeEach(async () => {
    adminNotifyMessageService = jasmine.createSpyObj(
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        {
          provide: AdminNotifyMessagesService,
          useValue: adminNotifyMessageService,
        },
        DatePipe,
      ],
    ...
    spyOn(modalService, 'open').and.returnValue(
      Object.assign({
        componentInstance: Object.assign({ response: of(true) }),
      }),
    );
