...
export const HealthResponseObj: HealthResponse = {
  ...
  components: {
    ...
    geoIp: {
      ...
      details: {
        reason:
          'The GeoLite Database file is missing (/var/lib/GeoIP/GeoLite2-City.mmdb)! Solr Statistics cannot generate location based reports! Please see the DSpace installation instructions for instructions to install this file.',
      },
    },
    solrOaiCore: {
      status: HealthStatus.UP,
