...
(function ($) {
    $.fn.pptxToHtml = function (options) {
        ...
        console.log("--------------- $result: ", $result, " divId: ", divId);
                    ...
                    FileReaderJS.setupBlob(blob, {
                        ...
                        on: {
                            load: function (e, file) {
                                $result.html(""); // clean the result div before processing
        ...
        function convertToHtml(file) {
            console.log("convertToHtml --------------------------: ", "#" + divId + " .slide");
            //'use strict';
            ...
            // console.log("settings.slideType: ", settings.slideType, "settings.slideMode: ", settings.slideMode);
            // console.log(' ------>>>>>>>>>>>>------------------------- $("#" + divId + " .slide") ----- ', $("#" + divId + " .slide"));
            // console.log(' ========= ', rslt_ary);
                ...
                switch (rslt_ary[i]["type"]) {
                    ...
                    case "ExecutionTime":
                        ...
                        if (settings.slideMode && !isSlideMode) {
                            if (settings.slideType == "revealjs" && document.getElementById("all_slides_warpper") === null) {
                                $("#" + divId + " .slide").wrapAll("<div id='all_slides_warpper' class='slides'></div>");
                            }
                            isSlideMode = true;
                            alert('dddd')
        ...
        function initSlideMode(divId, settings) {
            ...
            if (settings.slideType == "" || settings.slideType == "divs2slidesjs") {
                ...
                // custom code - Ashish Rawat 
                if (!revealJsFound && typeof Reveal !== 'undefined') {
                    alert('2nd');
